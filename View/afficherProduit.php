...
<thead>
<tr>
	<th onclick="sortTable(0)">Identifiant de produit </th>
    <th onclick="sortTable(1)">Nom de produit</th>
	<th onclick="sortTable(3)">Prix</th>
    <th onclick="sortTable(0)">Id de la categorie </th>
...
<button class="item" data-toggle="tooltip" data-placement="top" title="Modifier">
    <a href="../views/modifierProduit.php?edit=<?php echo $row['idpdt'];?>">
...
<button class="item" data-toggle="tooltip" data-placement="top" title="Supprimer">
    <a href="../views/supprimerproduit.php?delid=<?php echo $row['idpdt'];?>">
